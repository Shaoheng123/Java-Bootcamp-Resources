...
public class Main {
    public static void main(String[] args) {
        ...
        usernames.stream().map(username->username.toUpperCase()).forEach(username->System.out.println(username));
